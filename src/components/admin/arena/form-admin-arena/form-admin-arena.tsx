...
export type FormAdminArenaViewProps = {
  formKey: string
...
export function FormAdminArenaView({ formKey, register, errors, isLoading, edit, onSubmit, onCancel }: FormAdminArenaViewProps) {
  return (
